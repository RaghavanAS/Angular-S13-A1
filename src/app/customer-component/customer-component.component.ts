...
export class CustomerComponentComponent implements OnInit {
  ...
  // Subscribing to the customer service and getting the customer details based on the id
  // Also verify if the customer is existing or new and set the flag
  ngOnInit() {
  ...
  onSave(Values) {
    ...
    // On save navigating to the customers page
